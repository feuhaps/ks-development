 ...
 */
package org.kuali.student.core.exemption.service.impl;
...
public class ExemptionServiceMapImpl implements ExemptionService, MockService {
    ...
    @Override
    public List<ValidationResultInfo> validateExemptionRequest(String validationTypeKey, ExemptionRequestInfo exemptionRequestInfo,
    ...
    @Override
    public ExemptionRequestInfo createExemptionRequest(String personId, String exemptionRequestTypeKey,
            ExemptionRequestInfo exemptionRequestInfo, ContextInfo contextInfo)
    ...
    @Override
    public ExemptionRequestInfo updateExemptionRequest(String exemptionRequestId, ExemptionRequestInfo exemptionRequestInfo,
            ContextInfo contextInfo)
    ...
    @Override
    public List<ExemptionRequestInfo> getRequestsByRequester(String requesterId, ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException {
    ...
    @Override
    public List<ExemptionRequestInfo> getRequestsByPerson(String personId, ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException {
    ...
    @Override
    public List<ValidationResultInfo> validateExemption(String validationTypeKey, ExemptionInfo exemptionInfo,
            ContextInfo contextInfo)
            throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
    ...
    @Override
    public ExemptionInfo createExemption(String exemptionRequestId, String exemptionTypeKey, ExemptionInfo exemptionInfo,
            ContextInfo contextInfo)
            throws AlreadyExistsException,
            DataValidationErrorException,
            InvalidParameterException,
    ...
    public List<ExemptionInfo> getExemptionsForPerson(String personId, ContextInfo contextInfo)
        ...
        for (ExemptionInfo info : exemptionMap.values()) {
            if (personId.equals(info.getPersonId())) {
                list.add(new ExemptionInfo(info));
            }
        }
        return list;
    }
    ...
    public List<ExemptionInfo> getExemptionsForRequest(String requestId, ContextInfo contextInfo)
        ...
        List<ExemptionInfo> list = new ArrayList<ExemptionInfo>();
        for (ExemptionInfo info : exemptionMap.values()) {
            if (requestId.equals(info.getPersonId())) {
                list.add(new ExemptionInfo(info));
            }
        }
        return list;
    ...
    public List<ExemptionInfo> getActiveExemptionsForPerson(String personId, Date asOfDate, ContextInfo contextInfo)
            ...
            PermissionDeniedException {
        List<ExemptionInfo> list = new ArrayList<ExemptionInfo>();
        for (ExemptionInfo info : this.getExemptionsForPerson(personId, contextInfo)) {
    ...
    @Override
    public List<ExemptionInfo> getActiveExemptionsByTypeForPerson(String typeKey, String personId, Date asOfDate,
            ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
    ...
    @Override
    public List<ExemptionInfo> getActiveExemptionsByTypeProcessAndCheckForPerson(String typeKey, String processKey, String checkId,
            String personId, Date asOfDate, ContextInfo contextInfo)
            throws InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
            PermissionDeniedException {
