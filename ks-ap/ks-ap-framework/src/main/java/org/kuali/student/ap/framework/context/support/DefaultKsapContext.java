...
import org.kuali.student.ap.framework.util.StaticUserDateUtil;
...
public class DefaultKsapContext implements KsapContext {
    ...
    public static void before(String principalId, LocaleInfo locale) {
        ...
        /*
             ...
             */
        DateTime staticDate = StaticUserDateUtil.getDateTimeForUser(principalId);
        if (staticDate != null) {
            ksctx.setCurrentDate(staticDate.toDate());
        }
        else {
