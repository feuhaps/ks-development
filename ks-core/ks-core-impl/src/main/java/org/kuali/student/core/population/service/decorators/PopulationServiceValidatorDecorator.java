...
public class PopulationServiceValidatorDecorator
    ...
    @Override
    public List<ValidationResultInfo> validatePopulation(String validationTypeId, String populationTypeKey,
    ...
    @Override
    public PopulationRuleInfo createPopulationRule(String populationRuleTypeKey, PopulationRuleInfo populationInfo,
        ...
        return getNextDecorator().createPopulationRule(populationRuleTypeKey, populationInfo, contextInfo);
    }
    ...
    public PopulationCategoryInfo createPopulationCategory(String populationCategoryTypeKey,
            PopulationCategoryInfo populationCategoryInfo, ContextInfo contextInfo) throws DataValidationErrorException,
            DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
