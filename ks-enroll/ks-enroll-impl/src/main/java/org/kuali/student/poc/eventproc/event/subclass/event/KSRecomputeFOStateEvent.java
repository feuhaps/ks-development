...
/**
 * Event to request recomputation of the FO state
 *
 * @author Kuali Student Team
 */
public class KSRecomputeFOStateEvent extends KSEvent {
    private String foId;
    public KSRecomputeFOStateEvent(String foId) throws OperationFailedException {
        super(KSEventFactory.FO_RECOMPUTE_STATE_EVENT_TYPE);
        this.foId = foId;
    }
