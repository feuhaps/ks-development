...
/**
 * Event type to change an invalid RG to a valid one by recomputing RG state
 *
 * @author Kuali Student Team
 */
public class KSValidateRGStateEventType extends KSEventType {
    public static final String EVENT_NAME = "kuali.event.validate.rg.state";
