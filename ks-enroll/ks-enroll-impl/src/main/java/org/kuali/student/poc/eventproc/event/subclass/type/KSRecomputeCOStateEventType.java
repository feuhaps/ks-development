...
/**
 * Event type to request a recomputation of CO state
 *
 * @author Kuali Student Team
 */
public class KSRecomputeCOStateEventType extends KSEventType {
    public static final String EVENT_NAME = "kuali.event.recompute.co.state";
    public static final List<KSEventAttributeKey> REQUIRED_KEYS;
    static {
        REQUIRED_KEYS = new ArrayList<KSEventAttributeKey>();
        REQUIRED_KEYS.add(KSEventFactory.EVENT_ATTRIBUTE_KEY_CO_ID);
    }

    public KSRecomputeCOStateEventType() {
