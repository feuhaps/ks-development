 ...
 */
public class CompletedCourseAsOfTermTermResolver extends CourseOfferingTermResolverSupport<Boolean> {
    ...
    public Boolean resolve(Map<String, Object> resolvedPrereqs, Map<String, String> parameters) throws TermResolutionException {
        ...
        try {
            ...
            String versionIndId = parameters.get(KSKRMSServiceConstants.TERM_PARAMETER_TYPE_COURSE_CLU_KEY);
